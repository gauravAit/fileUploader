document.addEventListener("DOMContentLoaded", function() {
    (function() {
        ...
        document.querySelectorAll("input[type=file].custom-configurable-uploader").forEach(function(input){
            ...
            uploader_holder.innerHTML = "<div class='custom-configurable_uploader progress_outer' style='border: 1px solid black;border-radius: 3px; display: none;width: 280px; margin-top: 5px;'><div class='custom-configurable_uploader progress' style=' width: 0%;background: #0091ca; height: 6px;'></div></div>";
